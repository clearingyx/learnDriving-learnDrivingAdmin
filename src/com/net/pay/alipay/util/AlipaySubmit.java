package com.net.pay.alipay.util;
...
import com.net.pay.alipay.config.AlipayConfig;
import com.net.pay.alipay.sign.MD5;
import com.net.pay.alipay.util.httpClient.HttpProtocolHandler;
import com.net.pay.alipay.util.httpClient.HttpRequest;
import com.net.pay.alipay.util.httpClient.HttpResponse;
import com.net.pay.alipay.util.httpClient.HttpResultType;
